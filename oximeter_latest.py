...
if i<len(o):
    ...
    updated_p.append(temp_sum2/c)

temp_sum1=0
temp_sum2=0
for i in range(len(updated_o)):
        temp_sum1+=updated_o[i]
        temp_sum2+=updated_p[i]    

final_o=temp_sum1/len(updated_o)
final_p=temp_sum2/len(updated_o)
print("Final Oximeter Reading: ",final_o)
print("Final pulseRate Reading: ",final_p)
